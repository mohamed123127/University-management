...
$client->setClientSecret(SecreteData::$clientSecret); // استبدلها بـ Client Secret
$client->setRedirectUri(SecreteData::$Url . "/University-management/backend/roots/callback.php");//الرابط العودة الذي تم تعيينه في Google People APi
...
if (isset($_GET['code'])) {
    ...
    $redirectUrl = SecreteData::$Url . ':3000?email=' . urlencode($userInfo->email) ;
