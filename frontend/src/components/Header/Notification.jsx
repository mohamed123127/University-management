    ...
    return (
        <div className={`${ClassName}`}>
            <button onClick={clickButtonHandled} className="relative flex justify-end">
                ...
                <h2 className="text-center text-blue-800 font-bold text-xl mt-1">Notifications</h2>
                ...
                {notificationsList.map((n) => (
                    ...
                    >
                      <h4 className="text-xs justify-self-start font-semibold text-blue-600">{n.Content}</h4>
