    ...
    <div className={`flex ${toggleButtonClassName}`}>
      ...
      <div className="flex w-[60px] h-[24px]">
        <div className={`flex border rounded-2xl h-full w-full relative ${isStudent ? 'bg-blue-300' : 'bg-blue-500'}`}>
          <div className={`absolute w-[22px] h-[22px] bg-white border border-gray-300 rounded-full transition-transform duration-300 ${isStudent ? 'ltr:left-0 rtl:right-0' : 'ltr:right-0 rtl:left-0'}`} />
