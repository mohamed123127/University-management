    ...
    <div className="p-6 w-full flex flex-col items-center">
      ...
      >
        ...
        <div className="text-justify text-[18px] my-6 font-serif">
          ...
          <p className="mt-3">Nous avons l’honneur et le plaisir de vous demander de bien vouloir recevoir l’étudiant :</p>
          <p className="mt-3">Inscrite en ……. année filière : Informatique sous le matricule 2222...</p>
