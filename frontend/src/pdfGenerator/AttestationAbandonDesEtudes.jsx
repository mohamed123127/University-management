...
export default function AttestationAbandonDesEtudes() {
  const { t } = useTranslation();
  const location = useLocation();
  const type = 'AttestationAbandonDesEtudes';
    ...
    <div className="p-4 w-full">
      ...
      >
        ...
        <h2 className="mt-16 text-2xl font-semibold mb-6 text-center bg-gray-400">
          <span className="">شــــهـــادة الــــتخـــلي عن الدراســـــــة </span><br />    </h2>
      ...
      <div className="mt-6 space-y-4 text-lg leading-8 pr-6">
        ...
        <p className='font-semibold ml-32'>تخصص: تطوير</p></div>
      </div>

  

<p className="mt-6 text-lg leading-8 text-justify pr-6">
  يعتبر في حالة إنقــــطاع عن التكــوين بناءً على نتائجه المتحصل عليها حسب مداولات السنة الجامعية 2021/2022 لعدم حضوره أي شكال من أشكال التعليم المنظمة من دروس وأعمال موجهة.....
</p>
<p className='mt-5 text-lg mr-5'>ضف لذلك انه لم يتقدم بأي طلب لإعــــــادة إدمــــــاجــه .</p>
      ...
      <div className="mt-28 text-left ltr font-semibold">
        ...
        <p className="mt-4 font-bold underline text-lg"> رئيس القسم الآلـــــــــــــــــــي</p>
      </div>
