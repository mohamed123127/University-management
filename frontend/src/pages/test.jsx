              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {problem.status === "accepted" && (
                    <span className="text-green-600 text-xl"><CheckCircle size={24} /></span>
                  )}
                  {problem.status === "refused" && (
                    <span className="text-red-600 text-xl">  <XCircle size={24} /></span>
                  )}
                </div>
              </div>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 backdrop-blur-sm z-50">
    <div className="bg-white shadow-lg p-4 rounded-lg border border-gray-300 w-80">
      ...
      <div className="flex justify-end mt-2">
        <button
         // onClick={}----- hna lfunction li tb3t biha reply
