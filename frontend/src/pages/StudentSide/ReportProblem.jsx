...
export default function Repport({Email,StudentId}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
        const result = await ReportProblem.Add({"title":repportData.title,"content":repportData.content,"email":Email,"studentId":StudentId});
